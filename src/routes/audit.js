...
// Test endpoint for debugging PageSpeed API
router.get('/test/pagespeed', async (req, res) => {
  try {
    const testUrl = req.query.url || 'https://movingagain.com.au';
    ...
    res.json({
      ...
      categories: Object.keys(response.data?.lighthouseResult?.categories || {}),
      envDebug
    });
